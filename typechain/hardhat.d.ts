...
declare module "hardhat/types/runtime" {
  interface HardhatEthersHelpers extends HardhatEthersHelpersBase {
    ...
    getContractFactory(name: "BDLockingContract", signerOrOptions?: ethers.Signer | FactoryOptions): Promise<Contracts.BDLockingContract__factory>;
    ...
    getContractAt(name: "BDLockingContract", address: string, signer?: ethers.Signer): Promise<Contracts.BDLockingContract>;
    getContractAt(name: "SampleERC20", address: string, signer?: ethers.Signer): Promise<Contracts.SampleERC20>;
